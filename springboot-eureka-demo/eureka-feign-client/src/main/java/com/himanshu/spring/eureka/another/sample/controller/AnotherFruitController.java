...
public class AnotherFruitController {
  ...
  @Autowired
  private ABootifulClient bootifulServiceClient;
  ...
  @RequestMapping(value = "/feign/fetch/{fruitName}", method = RequestMethod.GET)
  public String getFruitDetailsFromFeign(@PathVariable("fruitName") String fruit) {
    System.out.println("Get fruit details using feign client: "+fruit);
    String response = bootifulServiceClient.getFruitDetails(fruit);
    System.out.println("Response received is: "+response);
    return response;
  }
