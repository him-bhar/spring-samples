...
import com.himanshu.poc.springbootsec.starter.SampleCommandLineStarter;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = SampleCommandLineStarter.class)
public class SpringBootCommandLineStarterTest {
  private Logger logger = LoggerFactory.getLogger(SpringBootCommandLineStarterTest.class);
